...
import fs from "fs";
import {
  cleanRecursiveThread, extractMediaFromThread, expandTweetUrls,
  hyperlinkHashTags, hyperlinkAts
...
describe("expand Tweet urls", async () => {
  ...
  it("should expand tweet urls and replace it with <a> tag", async () => {
    const dataInput = "The Q&A livestream is beginning! Join to learn about #crypto, #bitcoin, and open blockchains: https://t.co/BKojmoEMEe https://t.co/PxnNojWb8b";
    const expectedOutput = "The Q&A livestream is beginning! Join to learn about #crypto, #bitcoin, and open blockchains: <a href=https://aantonop.io/mar21qa>https://aantonop.io/mar21qa</a>";
...
describe("replace hasthags with hyperlinks", () => {
  ...
  const expectedOutput = "This is a <a href=https://twitter.com/hashtag/test>#test</a> tweet that includes <a href=https://twitter.com/hashtag/hashtags>#hashtags</a> in <a href=https://twitter.com/hashtag/لغات_عدة>#لغات_عدة</a> and works fine";
...
describe("replace mention handles with hyperlinks", () => {
  ...
  const expectedOutput = "This is a test tweet that mentions <a href=https://twitter.com/Twitter>@Twitter</a> and <a href=https://twitter.com/TwitterSupport>@TwitterSupport</a>";
